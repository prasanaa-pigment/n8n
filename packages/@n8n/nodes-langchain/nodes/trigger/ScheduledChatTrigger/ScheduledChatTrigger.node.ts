...
export class ScheduledChatTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'Scheduled Chat Trigger',
		name: 'scheduledChatTrigger',
		icon: 'fa:clock',
		iconColor: 'black',
		group: ['trigger', 'schedule'],
		version: 1,
		description: 'Starts a chat hub conversation on a schedule',
		eventTriggerDescription: '',
		activationMessage:
			'Your scheduled chat trigger will now create chat sessions on the schedule you have defined.',
		defaults: {
			name: 'Scheduled Chat Trigger',
		},
		maxNodes: 1,
		inputs: [],
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								options: [
									{ name: 'Midnight', displayName: 'Midnight', value: 0 },
									{ name: '1am', displayName: '1am', value: 1 },
									{ name: '2am', displayName: '2am', value: 2 },
									{ name: '3am', displayName: '3am', value: 3 },
									{ name: '4am', displayName: '4am', value: 4 },
									{ name: '5am', displayName: '5am', value: 5 },
									{ name: '6am', displayName: '6am', value: 6 },
									{ name: '7am', displayName: '7am', value: 7 },
									{ name: '8am', displayName: '8am', value: 8 },
									{ name: '9am', displayName: '9am', value: 9 },
									{ name: '10am', displayName: '10am', value: 10 },
									{ name: '11am', displayName: '11am', value: 11 },
									{ name: 'Noon', displayName: 'Noon', value: 12 },
									{ name: '1pm', displayName: '1pm', value: 13 },
									{ name: '2pm', displayName: '2pm', value: 14 },
									{ name: '3pm', displayName: '3pm', value: 15 },
									{ name: '4pm', displayName: '4pm', value: 16 },
									{ name: '5pm', displayName: '5pm', value: 17 },
									{ name: '6pm', displayName: '6pm', value: 18 },
									{ name: '7pm', displayName: '7pm', value: 19 },
									{ name: '8pm', displayName: '8pm', value: 20 },
									{ name: '9pm', displayName: '9pm', value: 21 },
									{ name: '10pm', displayName: '10pm', value: 22 },
									{ name: '11pm', displayName: '11pm', value: 23 },
								],
